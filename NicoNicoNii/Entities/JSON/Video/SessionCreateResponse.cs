...
public sealed class SessionCreateResponse
{
	...
	public sealed class Session
	{
		...
		[JsonPropertyName("content_src_id_sets")] public List<ContentSrcIdSet> ContentSrcIdSets { get; set; } = new();

		[JsonPropertyName("content_type")] public string ContentType { get; set; }

		[JsonPropertyName("timing_constraint")] public string TimingConstraint { get; set; }

		[JsonPropertyName("keep_method")] public KeepMethod KeepMethod { get; set; }

		[JsonPropertyName("protocol")] public Protocol Protocol { get; set; }

		[JsonPropertyName("play_seek_time")] public long? PlaySeekTime { get; set; }

		[JsonPropertyName("play_speed")] public double? PlaySpeed { get; set; }

		[JsonPropertyName("play_control_range")] public PlayControlRange PlayControlRange { get; set; }

		[JsonPropertyName("content_uri")] public Uri ContentUri { get; set; }

		[JsonPropertyName("session_operation_auth")] public SessionOperationAuth SessionOperationAuth { get; set; }

		[JsonPropertyName("content_auth")] public ContentAuth ContentAuth { get; set; }

		[JsonPropertyName("runtime_info")] public RuntimeInfo RuntimeInfo { get; set; }

		[JsonPropertyName("client_info")] public ClientInfo ClientInfo { get; set; }

		[JsonPropertyName("created_time")] public long? CreatedTime { get; set; }

		[JsonPropertyName("modified_time")] public long? ModifiedTime { get; set; }

		[JsonPropertyName("priority")] public double? Priority { get; set; }

		[JsonPropertyName("content_route")] public long? ContentRoute { get; set; }
	...
	public sealed class ContentAuth
	{
		...
		[JsonPropertyName("max_content_count")] public long? MaxContentCount { get; set; }
	...
	public sealed class Heartbeat
	{
		...
		[JsonPropertyName("onetime_token")] public string OnetimeToken { get; set; }
	...
	public sealed class RuntimeInfo
	{
		...
		[JsonPropertyName("execution_history")] public List<object> ExecutionHistory { get; set; } = new();
