...
//HTTP Protocol
public sealed class SessionCreateHls
{
    public SessionCreateHls(WatchPageData watchPage, IEnumerable<string> audioQuality, IEnumerable<string> videoQuality, bool loggedIn)
    {
        ...
        this.Session.Protocol.Parameters.HttpParameters.Parameters.HlsParameters.UseWellKnownPort =
            watchPage.Media.Delivery.Movie.Session.Urls[0].IsWellKnownPort == true
                ? "yes"
                : "no";

        this.Session.Protocol.Parameters.HttpParameters.Parameters.HlsParameters.UseSsl =
            watchPage.Media.Delivery.Movie.Session.Urls[0].IsSsl == true
                ? "yes"
                : "no";
        ...
        this.Session.Priority = loggedIn
            ? 0.8
            : 0;
    }
    ...
    public sealed class HlsParameters
    {
